...
$bracelet_type = $_GET['bracelet_type'] ?? ''; // '', 'clay', 'themed'
...
if ($bracelet_type !== '' && in_array($bracelet_type, ['clay','themed'],true)) {
    $where[] = 'bracelet_type = ?';
    $args[] = $bracelet_type;
}
    ...
    <div class="admin-hero">
        <form class="admin-hero-card" method="get" style="display:grid;grid-template-columns:repeat(6,1fr);gap:10px">
            ...
            <select name="bracelet_type">
                <option value="">Bracelet style: any</option>
                <option value="clay"   <?= $bracelet_type === 'clay'   ? 'selected' : '' ?>>Clay beads</option>
                <option value="themed" <?= $bracelet_type === 'themed' ? 'selected' : '' ?>>Themed</option>
            </select>
        ...
        <form method="post" id="bulk-form">
            ...
            <table class="orders-table" style="width:100%;border-collapse:collapse;table-layout:fixed">
                ...
                <tr>
                    ...
                    <th style="width:130px"><?= sortLink('Style','bracelet_type') ?></th>
                    ...
                    <tr style="background:#fff;box-shadow:0 8px 18px rgba(20,16,37,.06);border-radius:14px">
                        ...
                        <td>
                            ...
                            if ($p['category'] === 'bracelet' && !empty($p['bracelet_type'])) {
                                echo h($p['bracelet_type'] === 'clay' ? 'Clay beads' : 'Themed');
                            } else {
                                echo '-';
                            }
                            ?>
